...
;Local $strLogFilePath = "\\eisf\NETLOGON\VisioProject_Uninstall_Results\"
Local $strLogFilePath = "C:\VisioProject_Uninstall_Results\"
...
$ComputerNamesProject2003[7]="mywse001"
...
$ComputerNamesVisio2003[8]="mywse001"
...
$ComputerNamesVisio2003[19]="mywse002"
...
$ComputerNamesProject2007[1]="mywse001"
$ComputerNamesProject2007[2]="mywse002"

$ComputerNamesVisio2007[0]="wse119"
$ComputerNamesVisio2007[1]="wse213"
;$ComputerNamesVisio2007[2]="eisf-lap081"
$ComputerNamesVisio2007[2]="mywse001"
...
$ComputerNamesVisio2007[6]="mywse002"
...
For $element In $ComputerNamesProject2003
   If StringCompare(@ComputerName, $element)==0 Then
	  ...
	  Local $hFile = FileOpen($strLogFilePath & $strLogFileName, 1) 									;Open the logfile in write mode.
	  _FileWriteLog($hFile, "MS Project 2003 has been Uninstalled on -" & @TAB & @ComputerName)			;Write to the logfile passing the filehandle returned by FileOpen.
...
For $element In $ComputerNamesVisio2003
   If StringCompare(@ComputerName, $element)==0 Then
	  ...
	  Local $hFile = FileOpen($strLogFilePath & $strLogFileName, 1) 									;Open the logfile in write mode.
	  _FileWriteLog($hFile, "MS Visio   2003 has been Uninstalled on -" & @TAB & @ComputerName)			;Write to the logfile passing the filehandle returned by FileOpen.
	  FileClose($hFile)																					;Close the filehandle to release the file.
   EndIf
Next
...
For $element In $ComputerNamesProject2007
   If StringCompare(@ComputerName, $element)==0 Then
	  ...
	  Local $hFile = FileOpen($strLogFilePath & $strLogFileName, 1) 									;Open the logfile in write mode.
	  _FileWriteLog($hFile, "MS Project 2007 has been Uninstalled on -" & @TAB & @ComputerName)			;Write to the logfile passing the filehandle returned by FileOpen.
	  FileClose($hFile)																					;Close the filehandle to release the file.
   EndIf
Next
...
For $element In $ComputerNamesVisio2007
   If StringCompare(@ComputerName, $element)==0 Then
	  ...
	  Local $hFile = FileOpen($strLogFilePath & $strLogFileName, 1) 									;Open the logfile in write mode.
	  _FileWriteLog($hFile, "MS Visio   2007 has been Uninstalled on -" & @TAB & @ComputerName)			;Write to the logfile passing the filehandle returned by FileOpen.
	  FileClose($hFile)																					;Close the filehandle to release the file.
   EndIf
Next
