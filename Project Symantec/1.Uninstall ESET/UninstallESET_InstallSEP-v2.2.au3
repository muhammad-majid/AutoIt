...
_FileWriteLog($hFileClient, "Uninstalling ESET and Installing Symantec End Point - Script v2.2")
...
$iPID = ShellExecute($strCallMsiPath, '/x {36A3719F-8A06-451A-935A-B4A5BAE77C87} /qn /norestart')						;Uninstall ESET v4 without Password')
...
if $strCallMsiPath = "" Then
   _FileWriteLog($hFileClient, "Uninstallation Successful...")
   _FileWriteLog($hFileClient, "Quitting...")
   Exit
Else
   _FileWriteLog($hFileClient, "Uninstall failed, proceeding with next try...")
EndIf


_FileWriteLog($hFileClient, "Attempting to Uninstall ESET v4 WITH password..")
$iPID = ShellExecute($strCallMsiPath, '/x {36A3719F-8A06-451A-935A-B4A5BAE77C87} /qn /norestart PASSWORD=admin12345')	;Uninstall ESET v4 with Password')
ProcessWaitClose($iPID)
$strCallMsiPath = _GetAppropriatePath('C:\Program Files\ESET\ESET*\callmsi.exe')										;Check if uninstall was success or failure. If success, callmsi.exe will get deleted.
if $strCallMsiPath = "" Then
   _FileWriteLog($hFileClient, "Uninstallation Successful...")
...
If @OSVersion = "WIN_XP" Or @OSVersion = "WIN_XPe" Then																	;XP mode
   ...
   $iPID = ShellExecute($strCallMsiPath, '/x {950B1859-7F95-4CCF-8674-0F843B58CCAB} /qn /norestart')						;Uninstall ESET v5 without password
   ProcessWaitClose($iPID)
   $strCallMsiPath = _GetAppropriatePath('C:\Program Files\ESET\ESET*\callmsi.exe')										;Check if uninstall was success or failure. If success, callmsi.exe will get deleted.
   if $strCallMsiPath = "" Then
	  _FileWriteLog($hFileClient, "Uninstallation Successful...")
   ...
   $iPID = ShellExecute($strCallMsiPath, '/x {950B1859-7F95-4CCF-8674-0F843B58CCAB} /qn /norestart PASSWORD=admin12345')	;Uninstall ESET v5 with Password
   ProcessWaitClose($iPID)
   $strCallMsiPath = _GetAppropriatePath('C:\Program Files\ESET\ESET*\callmsi.exe')										;Check if uninstall was success or failure. If success, callmsi.exe will get deleted.
   if $strCallMsiPath = "" Then
	  _FileWriteLog($hFileClient, "Uninstallation Successful...")
...
Else																													;Win7, 8, 2008, 2012 mode
   ...
   _FileWriteLog($hFileClient, "Attempting to Uninstall ESET v5 WITHOUT password")
   $iPID = ShellExecute($strCallMsiPath, '/x {4544542B-6BC5-4BA8-AA52-05C07A1D59F1} /qn /norestart')						;Uninstall ESET v5 without password
   ProcessWaitClose($iPID)
   $strCallMsiPath = _GetAppropriatePath('C:\Program Files\ESET\ESET*\callmsi.exe')										;Check if uninstall was success or failure. If success, callmsi.exe will get deleted.
   if $strCallMsiPath = "" Then
	  _FileWriteLog($hFileClient, "Uninstallation Successful...")
   ...
   _FileWriteLog($hFileClient, "Attempting to Uninstall ESET v5 WITH password")
   $iPID = ShellExecute($strCallMsiPath, '/x {4544542B-6BC5-4BA8-AA52-05C07A1D59F1} /qn /norestart PASSWORD=admin12345')	;Uninstall ESET v5 with Password
   ProcessWaitClose($iPID)
   $strCallMsiPath = _GetAppropriatePath('C:\Program Files\ESET\ESET*\callmsi.exe')										;Check if uninstall was success or failure. If success, callmsi.exe will get deleted.
   if $strCallMsiPath = "" Then
	  _FileWriteLog($hFileClient, "Uninstallation Successful...")
