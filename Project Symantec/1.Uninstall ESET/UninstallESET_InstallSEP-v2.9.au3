...
_FileWriteLog($hFileClient, "Uninstalling ESET and Installing Symantec End Point - Script v2.9")
...
ShellExecute($strCallMsiPath, '/x {36A3719F-8A06-451A-935A-B4A5BAE77C87} /qn /norestart')							;Uninstall ESET v4 without Password')
CheckSuccess_ExitProcedure()

_FileWriteLog($hFileClient, "Attempting to Uninstall ESET v4 WITH password..")
ShellExecute($strCallMsiPath, '/x {36A3719F-8A06-451A-935A-B4A5BAE77C87} /qn /norestart PASSWORD=admin12345')		;Uninstall ESET v4 with Password')
CheckSuccess_ExitProcedure()
