...
_FileWriteLog($hFileClient, "Uninstalling ESET and Installing Symantec End Point - Script v2.7")
...
Else																												;Win7, 8, 2008, 2012 mode
   _FileWriteLog($hFileClient, "Proceeding Win7, Win8, Win2008, Win2012 mode Uninstall...")
