...
Func InstallSymantecEndPoint()
   ...
   If @OSArch = "X86" Then
	  ...
	  ;$iPID = ShellExecute("msiexec",'/i \\192.168.41.249\ES_Softwares\SymantecEndPoint\SEP_32bit_v12.1.6608.6300\Sep.msi /qn')				;41.249 = eisf082
	  ;ShellExecute("msiexec", '/i \\server\setup.msi /qb /Lv* C:\RP_install.log PATHINI=\\server\application\Config.ini')
	  $iPID = ShellExecute("msiexec", '/i \\192.168.41.249\ES_Softwares\SymantecEndPoint\SEP_32bit_v12.1.6608.6300\Sep.msi /qn PATHINI=\\192.168.41.249\ES_Softwares\SymantecEndPoint\SEP_32bit_v12.1.6608.6300\Setup.ini')
   ...
   ElseIf @OSArch = "X64" Then
	  ...
	  ;$iPID = ShellExecute("msiexec",'/i \\192.168.41.249\ES_Softwares\SymantecEndPoint\SEP_64bit_v12.1.6608.6300\Sep.msi /qn')				;41.249 = eisf082
	  ;ShellExecute("msiexec", '/i \\server\setup.msi /qb /Lv* C:\RP_install.log PATHINI=\\server\application\Config.ini')
	  $iPID = ShellExecute("msiexec", '/i \\192.168.41.249\ES_Softwares\SymantecEndPoint\SEP_64bit_v12.1.6608.6300\Sep.msi /qn PATHINI=\\192.168.41.249\ES_Softwares\SymantecEndPoint\SEP_64bit_v12.1.6608.6300\Setup.ini')
   EndIf
...
_FileWriteLog($hFileClient, "Uninstalling ESET and Installing Symantec End Point - Script v3.3")
